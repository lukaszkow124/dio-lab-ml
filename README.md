...
## Launch studio
1. In your Azure Machine Learning workspace resource, select Launch studio (or open a new browser tab and navigate to https://ml.azure.com, and sign into Azure Machine Learning studio using your Microsoft account). Close any messages that are displayed.

2. In Azure Machine Learning studio, you should see your newly created workspace. If not, select All workspaces in the left-hand menu and then select the workspace you just created.
...
> The data used in this exercise is derived from Capital Bikeshare and is used in accordance with the published data license agreement.
...
2. Wait for the deployment to start - this may take a few seconds. The Deploy status for the endpoint will be indicated in the main part of the page as Running.
...
2. On the real-time endpoint page view the Test tab.
